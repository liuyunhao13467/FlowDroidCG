...
import flowdroid.entities.MyUnitEdge;
...
public class UnitGraphExporter {
	...
	protected List<MyUnitEdge> edges = new ArrayList<MyUnitEdge>();
	...
	public void setIdForUG(UnitGraph ug) {
		...
		while (unitIt.hasNext()) {
			...
			for (Unit son : ug.getSuccsOf(current)) {
				edges.add(new MyUnitEdge(edgeIp++, unit2Id.get(current), unit2Id.get(son)));
			}
		}
	}
